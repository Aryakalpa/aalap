    ...
    <div>
      ...
      <div className="soul-card" onClick={toggleTheme} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', background: theme === 'paper' ? '#fff' : '#222' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
                <h3 style={{ margin: 0, fontSize: '18px', fontWeight: 700, fontFamily: 'var(--font-serif)' }}>পৰিৱেশ সলনি কৰক</h3> {/* Change Environment */}
      ...
      <button 
        ...
        style={{ 
            ...
            color: 'var(--danger)', borderRadius: '20px', 
