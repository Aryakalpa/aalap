...
export default function SettingsScreen() {
   const { theme, setTheme, signOut } = useStore();
   ...
   return (
      <div style={{ padding: 20 }}>
         ...
         <button onClick={() => { signOut(); navigate('/'); }} style={{ width: '100%', padding: 15, borderRadius: 12, border: '1px solid var(--glass-border)', background: 'transparent', color: 'var(--text-secondary)', fontWeight: 600, cursor: 'pointer' }}>
            Log Out
         </button>
      </div>
   );
